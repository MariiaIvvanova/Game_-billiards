...
from config import W, H, GAME_RES, FPS, W_grid, H_grid
...
def init_game():
    ...
    grid = [pygame.Rect(x * 30, y * 30, 30, 30) for x in range(W_grid) for y in range(H_grid)]
...
def main():
    ...
    menu_screen = pygame.image.load('../pythonProject16/assets/заставка1.png')
    menu_screen = pygame.transform.scale(menu_screen, (300, 600))
    game_over_screen = pygame.image.load('../pythonProject16/assets/game_over.webp')
    game_over_screen = pygame.transform.scale(game_over_screen, (300, 600))
    back_ground = pygame.image.load('../pythonProject16/assets/рабочий_стол_игры.jpeg')
